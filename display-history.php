...
function Header()
{
    ...
    $this->Cell(80);
    // Title
    $this->Cell(30,75,'Brief History of AUF',0,1,'C');
    // Line break
    $this->Ln(-25);
}
...
On February 20, 1990, the five-storey, 125-bed AUF Medical Center was inaugurated which now serves as a private teaching, training and research hospital, the first ever in Central Luzon.');
$pdf->Output();
?>